...
#include "batmobile_integrated/msg/control_instructions.hpp"
#include <vector>
#include <cmath>
#include <thread>
...
public:
    ControlsPublisher() : Node("control_publisher") {
        control_publisher = this->create_publisher<batmobile_integrated::msg::ControlInstructions>(
            "Control_instruction", 10);
    }

    static int setControl(float linear_speed, float angular_speed, float cannon_angle, bool shoot) {
        auto control_msg = batmobile_integrated::msg::ControlInstructions();
...
private:
    static rclcpp::Publisher<batmobile_integrated::msg::ControlInstructions>::SharedPtr control_publisher;
};

// Initialize static member
rclcpp::Publisher<batmobile_integrated::msg::ControlInstructions>::SharedPtr ControlsPublisher::control_publisher;
